...
func (x *ReadMovieRequest) GetMovie() *Movie {
	if x != nil {
		return x.Movie
	}
	return nil
...
var file_proto_movie_proto_rawDesc = []byte{
	...
	0x6f, 0x76, 0x69, 0x65, 0x22, 0x36, 0x0a, 0x10, 0x52, 0x65, 0x61, 0x64, 0x4d, 0x6f, 0x76, 0x69,
	...
	0x4d, 0x6f, 0x76, 0x69, 0x65, 0x52, 0x05, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x22, 0x37, 0x0a, 0x11,
	...
	0x68, 0x65, 0x62, 0x69, 0x67, 0x79, 0x6f, 0x76, 0x61, 0x64, 0x69, 0x61, 0x7a, 0x2f, 0x67, 0x6f,
	0x2d, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x70, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x62, 0x06, 0x70,
...
var file_proto_movie_proto_depIdxs = []int32{
	...
	0,  // 2: proto.ReadMovieRequest.movie:type_name -> proto.Movie
	0,  // 3: proto.ReadMovieResponse.movie:type_name -> proto.Movie
	0,  // 4: proto.ReadMoviesResponse.movies:type_name -> proto.Movie
	0,  // 5: proto.UpdateMovieRequest.movie:type_name -> proto.Movie
	0,  // 6: proto.UpdateMovieResponse.movie:type_name -> proto.Movie
	1,  // 7: proto.MovieService.CreateMovie:input_type -> proto.CreateMovieRequest
	3,  // 8: proto.MovieService.GetMovie:input_type -> proto.ReadMovieRequest
	5,  // 9: proto.MovieService.GetMovies:input_type -> proto.ReadMoviesRequest
	7,  // 10: proto.MovieService.UpdateMovie:input_type -> proto.UpdateMovieRequest
	9,  // 11: proto.MovieService.DeleteMovie:input_type -> proto.DeleteMovieRequest
	2,  // 12: proto.MovieService.CreateMovie:output_type -> proto.CreateMovieResponse
	4,  // 13: proto.MovieService.GetMovie:output_type -> proto.ReadMovieResponse
	6,  // 14: proto.MovieService.GetMovies:output_type -> proto.ReadMoviesResponse
	8,  // 15: proto.MovieService.UpdateMovie:output_type -> proto.UpdateMovieResponse
	10, // 16: proto.MovieService.DeleteMovie:output_type -> proto.DeleteMovieResponse
...
func file_proto_movie_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_movie_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Movie); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_movie_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_proto_movie_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_proto_movie_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_proto_movie_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_proto_movie_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_proto_movie_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_proto_movie_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_proto_movie_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_proto_movie_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_proto_movie_proto_msgTypes[10].Exporter = func(v any, i int) any {
